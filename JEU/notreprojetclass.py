...
while run:
    ...
    if not (Robot.saute):
        ...
        if Robot.impulsion == 1:
            if Robot.Compteursaut > 0:
                Robot.y -= (Robot.Compteursaut ** 2) * 0.5 + 7
    ...
    # Petite arene1:
    if 195 < Robot.x < 390 and 200 <= Robot.y <= 207:
        Robot.impulsion = 1
        Robot.y -= 7

    # Petit arene2:
    if 540 < Robot.x < 730 and 200 <= Robot.y <= 207:
        Robot.impulsion = 1
        Robot.y -= 7
    # Haute arene:
    if 370 < Robot.x < 560 and 75 <= Robot.y <= 82:
        Robot.impulsion = 1
        Robot.y -= 7
    ...
    # Grande arene:
    if 150 < Ninja.x < 800 and 315 <= Ninja.y <= 322:
        Ninja.impulsion = 2
        Ninja.y -= 7

    # Petite arene1:
    if 195 < Ninja.x < 390 and 200 <= Ninja.y <= 207:
        Ninja.impulsion = 2
        Ninja.y -= 7

    # Petit arene2:
    if 540 < Ninja.x < 730 and 200 <= Ninja.y <= 207:
        Ninja.impulsion = 2
        Ninja.y -= 7
    # Haute arene:
    if 370 < Ninja.x < 560 and 75 <= Ninja.y <= 82:
        Ninja.impulsion = 2
        Ninja.y -= 7
